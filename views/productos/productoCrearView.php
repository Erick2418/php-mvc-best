...
<div class="col-12 p-5">
    <div class="mask mb-5" style="background-color: rgba(0, 0, 0, 0.6)">
        <div class="d-flex justify-content-center align-items-center h-100">
            <h1 class="text-white text-center align-middle mp-3">Nuevo producto</h1>
        </div>
    </div>
    <form>
        <div class="row mb-4">
            ...
            <div class="col text-right">
                <select class="form-control" name="input_tipo" id="input_tipo">
                    <option>Titpo 1</option>
                    <option>Titpo 2</option>
                    <option>Titpo 3</option>
                </select>
                <label class="form-label mr-3" for="input_tipo" style="color: #555">Tipo</label>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col">
